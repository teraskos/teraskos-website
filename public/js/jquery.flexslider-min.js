    ...
    e.flexslider = function (t, n) {
        ...
        v = {
            init: function () {
                ...
                r.vars.keyboard &&
                    (e(r.containerSelector).length === 1 ||
                ...
                r.vars.mousewheel &&
                    r.bind("mousewheel", function (e, t, n, i) {
                        e.preventDefault();
                        var s =
                            t < 0 ? r.getTarget("next") : r.getTarget("prev");
                    ...
                    if (!s)
                        r.slides.click(function (t) {
                            ...
                            if (o <= 0 && n.hasClass(i + "active-slide"))
                                ...
                                !e(r.vars.asNavFor).data("flexslider")
                                    .animating &&
                                !n.hasClass(i + "active-slide")
                            ) {
                                r.direction =
                                    r.currentItem < s ? "next" : "prev";
                                r.flexAnimate(
                                    s,
            ...
            pausePlay: {
                setup: function () {
                    ...
                    v.pausePlay.update(
                        r.vars.slideshow ? i + "pause" : i + "play"
                    );
