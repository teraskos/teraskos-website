...
(function (window) {
    ...
    function isPropertySupported(property) {
        ...
        while (
            --i > -1 &&
            tempDiv.style[prefixes[i] + property] === undefined
        ) {}
        return i >= 0;
    }
    ...
    var Jarallax = (function () {
        ...
        function Jarallax_inner(item, userOptions) {
            ...
            _this.image = {
                ...
                position:
                    !supportTransform3D || isFirefox ? "absolute" : "fixed"
            };
    ...
    Jarallax.prototype.css = function (el, styles) {
        ...
        if (styles.transform) {
            ...
            styles.WebkitTransform = styles.MozTransform = styles.msTransform = styles.OTransform =
                styles.transform;
        }
